...
--
-- Host: localhost
-- Generation Time: May 25, 2017 at 08:36 PM
...
CREATE TABLE `team` (
  ...
  `name` varchar(150) NOT NULL,
  `budget` float NOT NULL DEFAULT '500',
  `value` float NOT NULL,
...
(1, 'Sam', 'psswd', NULL, 0),
(2, 'Ash', 'psswd', NULL, 0),
(3, 'Silas', 'psswd', NULL, 0),
(4, 'Ford', 'psswd', NULL, 0),
(5, 'Willis', 'psswd', NULL, 0),
(6, 'Lex', 'psswd', NULL, 0),
(12, 'TestUser', '$2y$10$Z40Sp0daK3WZ2RLCrH/9/eQX.mmVzEcgY6iAx4iVDDBp8E//0bKV.', NULL, 0);
