...
--
-- Host: localhost
-- Generation Time: May 29, 2017 at 10:12 AM
...
CREATE TABLE `team` (
  ...
  `name` varchar(150) NOT NULL,
  `zacetniBudget` float NOT NULL DEFAULT '500',
  `value` float NOT NULL,
  `points` int(3) NOT NULL DEFAULT '0',
  `transfers` int(3) NOT NULL DEFAULT '15',
  `ostaliBudget` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `team` (`ID`, `ID_user`, `name`, `zacetniBudget`, `value`, `points`, `transfers`, `ostaliBudget`) VALUES
(1, 1, 'Pravi Študentje', 500, 58, 0, 15, 442),
(2, 2, 'Pravi Kmetje', 500, 195, 0, 15, 305),
(3, 3, 'Stari Študentje', 500, 70, 0, 15, 430),
(4, 4, 'Stari Lisjaki', 500, 107, 0, 15, 393),
(5, 5, 'Beli Motoristi', 500, 117, 0, 15, 383),
(6, 6, 'Jezni Vikingi', 500, 141, 0, 15, 359),
(7, 7, 'Mladi Vikingi', 500, 43, 0, 15, 457),
(8, 8, 'Stari Šampinjoni', 500, 167, 0, 15, 333),
(9, 9, 'Hitri Študentje', 500, 146, 0, 15, 354),
(10, 10, 'Beli Šampinjoni', 500, 194, 0, 15, 306),
(11, 11, 'Beli Bolniki', 500, 110, 0, 15, 390),
(12, 12, 'Stari Lisjaki', 500, 149, 0, 15, 351),
(13, 13, 'Stari Študentje', 500, 158, 0, 15, 342),
(14, 14, 'Grdi Mladostniki', 500, 152, 0, 15, 348),
(15, 15, 'Pravi Jezdeci', 500, 80, 0, 15, 420),
(16, 16, 'Grdi Vikingi', 500, 74, 0, 15, 426),
(17, 17, 'Mladi Mladostniki', 500, 158, 0, 15, 342),
(18, 18, 'Mladi Jezdeci', 500, 52, 0, 15, 448),
(19, 19, 'Mladi Jezdeci', 500, 161, 0, 15, 339),
(20, 20, 'Poskočni Bolniki', 500, 124, 0, 15, 376),
(21, 21, 'Pravi Strelci', 500, 86, 0, 15, 414),
(22, 22, 'Trdi Gobani', 500, 164, 0, 15, 336),
(23, 23, 'Modri Kmetje', 500, 172, 0, 15, 328),
(24, 24, 'Pravi Mladostniki', 500, 133, 0, 15, 367),
(25, 25, 'Grdi Lisjaki', 500, 109, 0, 15, 391),
(26, 26, 'Poskočni Bolniki', 500, 127, 0, 15, 373),
(27, 27, 'Jezni Študentje', 500, 143, 0, 15, 357),
(28, 28, 'Modri Bolniki', 500, 106, 0, 15, 394),
(29, 29, 'Stari Gobani', 500, 115, 0, 15, 385),
(30, 30, 'Mladi Jezdeci', 500, 74, 0, 15, 426),
(31, 31, 'Poskočni Bolniki', 500, 103, 0, 15, 397),
(32, 32, 'Modri Motoristi', 500, 98, 0, 15, 402),
(33, 33, 'Stari Šampinjoni', 500, 123, 0, 15, 377),
(34, 34, 'Trdi Lisjaki', 500, 82, 0, 15, 418),
(35, 35, 'Pravi Mladostniki', 500, 67, 0, 15, 433),
(36, 36, 'Stari Študentje', 500, 76, 0, 15, 424),
(37, 37, 'Modri Kmetje', 500, 142, 0, 15, 358),
(38, 38, 'Stari Bolniki', 500, 131, 0, 15, 369),
(39, 39, 'Beli Mladostniki', 500, 63, 0, 15, 437),
(40, 40, 'Grdi Študentje', 500, 95, 0, 15, 405),
(41, 41, 'Stari Lisjaki', 500, 71, 0, 15, 429),
(42, 42, 'Grdi Strelci', 500, 93, 0, 15, 407),
(43, 43, 'Stari Mladostniki', 500, 109, 0, 15, 391),
(44, 44, 'Črni Strelci', 500, 159, 0, 15, 341),
(45, 45, 'Modri Kmetje', 500, 127, 0, 15, 373),
(46, 46, 'Jezni Lisjaki', 500, 107, 0, 15, 393),
(47, 47, 'Mladi Vikingi', 500, 77, 0, 15, 423),
(48, 48, 'Grdi Lisjaki', 500, 86, 0, 15, 414),
(49, 49, 'Jezni Strelci', 500, 105, 0, 15, 395),
(50, 50, 'Jezni Strelci', 500, 77, 0, 15, 423),
(51, 51, 'Poskočni Študentje', 500, 73, 0, 15, 427),
(52, 52, 'Modri Mladostniki', 500, 94, 0, 15, 406),
(53, 53, 'Stari Gobani', 500, 66, 0, 15, 434),
(54, 54, 'Beli Kmetje', 500, 93, 0, 15, 407),
(55, 55, 'Jezni Kmetje', 500, 82, 0, 15, 418),
(56, 56, 'Jezni Šampinjoni', 500, 119, 0, 15, 381),
(57, 57, 'Grdi Bolniki', 500, 82, 0, 15, 418),
(58, 58, 'Poskočni Gobani', 500, 120, 0, 15, 380),
(59, 59, 'Poskočni Gobani', 500, 162, 0, 15, 338),
(60, 60, 'Jezni Vikingi', 500, 180, 0, 15, 320),
(61, 61, 'Pravi Mladostniki', 500, 126, 0, 15, 374),
(62, 62, 'Jezni Kmetje', 500, 102, 0, 15, 398),
(63, 63, 'Beli Motoristi', 500, 79, 0, 15, 421),
(64, 64, 'Črni Šampinjoni', 500, 85, 0, 15, 415),
(65, 65, 'Beli Bolniki', 500, 115, 0, 15, 385),
(66, 66, 'Beli Gobani', 500, 150, 0, 15, 350),
(67, 67, 'Mladi Študentje', 500, 151, 0, 15, 349),
(68, 68, 'Beli Šampinjoni', 500, 239, 0, 15, 261),
(69, 69, 'Stari Motoristi', 500, 152, 0, 15, 348),
(70, 70, 'Trdi Bolniki', 500, 109, 0, 15, 391),
(71, 71, 'Pravi Jezdeci', 500, 114, 0, 15, 386),
(72, 72, 'Poskočni Šampinjoni', 500, 86, 0, 15, 414),
(73, 73, 'Hitri Motoristi', 500, 151, 0, 15, 349),
(74, 74, 'Beli Strelci', 500, 57, 0, 15, 443),
(75, 75, 'Trdi Motoristi', 500, 156, 0, 15, 344),
(76, 76, 'Trdi Študentje', 500, 88, 0, 15, 412),
(77, 77, 'Beli Mladostniki', 500, 122, 0, 15, 378),
(78, 78, 'Mladi Bolniki', 500, 128, 0, 15, 372),
(79, 79, 'Pravi Lisjaki', 500, 152, 0, 15, 348),
(80, 80, 'Pravi Šampinjoni', 500, 107, 0, 15, 393),
(81, 81, 'Grdi Gobani', 500, 101, 0, 15, 399),
(82, 82, 'Grdi Mladostniki', 500, 131, 0, 15, 369),
(83, 83, 'Beli Študentje', 500, 132, 0, 15, 368),
(84, 84, 'Hitri Mladostniki', 500, 112, 0, 15, 388),
(85, 85, 'Beli Gobani', 500, 79, 0, 15, 421),
(86, 86, 'Pravi Jezdeci', 500, 116, 0, 15, 384),
(87, 87, 'Črni Bolniki', 500, 158, 0, 15, 342),
(88, 88, 'Beli Šampinjoni', 500, 86, 0, 15, 414),
(89, 89, 'Pravi Vikingi', 500, 116, 0, 15, 384),
(90, 90, 'Črni Bolniki', 500, 144, 0, 15, 356),
(91, 91, 'Grdi Šampinjoni', 500, 95, 0, 15, 405),
(92, 92, 'Trdi Jezdeci', 500, 165, 0, 15, 335),
(93, 93, 'Mladi Kmetje', 500, 73, 0, 15, 427),
(94, 94, 'Hitri Gobani', 500, 64, 0, 15, 436),
(95, 95, 'Beli Šampinjoni', 500, 150, 0, 15, 350),
(96, 96, 'Modri Lisjaki', 500, 193, 0, 15, 307),
(97, 97, 'Črni Jezdeci', 500, 155, 0, 15, 345),
(98, 98, 'Črni Motoristi', 500, 220, 0, 15, 280),
(99, 99, 'Trdi Strelci', 500, 235, 0, 15, 265),
(100, 100, 'Beli Bolniki', 500, 58, 0, 15, 442);
...
(1, 'uporabnik', 'password', NULL, 0),
(2, 'yLt5ck', 'password', NULL, 0),
(3, '6COXTX', 'password', NULL, 0),
(4, 'DxOInn', 'password', NULL, 0),
(5, 'jYgknl', 'password', NULL, 0),
(6, 'ZKsTOs', 'password', NULL, 0),
(7, 'yepP6s', 'password', NULL, 0),
(8, '2G69on', 'password', NULL, 0),
(9, 'ZqHJLQ', 'password', NULL, 0),
(10, 'F7Sxxn', 'password', NULL, 0),
(11, 'i40Qvx', 'password', NULL, 0),
(12, 'jmry9g', 'password', NULL, 0),
(13, 'CcLqX4', 'password', NULL, 0),
(14, 'Q9YgDj', 'password', NULL, 0),
(15, 'BmQfkt', 'password', NULL, 0),
(16, 'HO6aTj', 'password', NULL, 0),
(17, 'pzGCdg', 'password', NULL, 0),
(18, 'L5Zklx', 'password', NULL, 0),
(19, 'HmajPt', 'password', NULL, 0),
(20, 'rhjfTL', 'password', NULL, 0),
(21, 'DMJBME', 'password', NULL, 0),
(22, 'FacYVg', 'password', NULL, 0),
(23, 'RkfhfO', 'password', NULL, 0),
(24, 'O1k2nQ', 'password', NULL, 0),
(25, 'y48BTv', 'password', NULL, 0),
(26, 'ODPsDM', 'password', NULL, 0),
(27, 'kvinRK', 'password', NULL, 0),
(28, '3hoMBQ', 'password', NULL, 0),
(29, 'nGaSO4', 'password', NULL, 0),
(30, 'sL91Hj', 'password', NULL, 0),
(31, 'm9BTUw', 'password', NULL, 0),
(32, 'pkLJOY', 'password', NULL, 0),
(33, 'pT3GMB', 'password', NULL, 0),
(34, 'PMoWn7', 'password', NULL, 0),
(35, 'bup2Cm', 'password', NULL, 0),
(36, '8oG9hw', 'password', NULL, 0),
(37, 'QW4f4l', 'password', NULL, 0),
(38, 'dXOqVs', 'password', NULL, 0),
(39, '3NW6hy', 'password', NULL, 0),
(40, 'tJqheH', 'password', NULL, 0),
(41, 'Y5rQTx', 'password', NULL, 0),
(42, 'PwFKBy', 'password', NULL, 0),
(43, 'fjti6k', 'password', NULL, 0),
(44, 'GAdnVM', 'password', NULL, 0),
(45, '1yrIxs', 'password', NULL, 0),
(46, 'WJcaDG', 'password', NULL, 0),
(47, 'ZifTmW', 'password', NULL, 0),
(48, '0eiFC1', 'password', NULL, 0),
(49, 'gBi7ek', 'password', NULL, 0),
(50, 'MQFVh5', 'password', NULL, 0),
(51, 'wZv9iD', 'password', NULL, 0),
(52, 'GTWrxE', 'password', NULL, 0),
(53, 'Vuhhep', 'password', NULL, 0),
(54, 'D7ifN0', 'password', NULL, 0),
(55, '8EwiaF', 'password', NULL, 0),
(56, '0OoUXV', 'password', NULL, 0),
(57, 'htDtMW', 'password', NULL, 0),
(58, 'IMnqrH', 'password', NULL, 0),
(59, '2vwAdh', 'password', NULL, 0),
(60, 'ahTl76', 'password', NULL, 0),
(61, 'yMAV8c', 'password', NULL, 0),
(62, 'i57Grq', 'password', NULL, 0),
(63, 'uPLhHJ', 'password', NULL, 0),
(64, 'tvIZhr', 'password', NULL, 0),
(65, '0GqVyp', 'password', NULL, 0),
(66, 'BiOh3q', 'password', NULL, 0),
(67, 'KRuCQh', 'password', NULL, 0),
(68, '7K45G9', 'password', NULL, 0),
(69, 'TqnGgQ', 'password', NULL, 0),
(70, 'VEFsyW', 'password', NULL, 0),
(71, '4RYRW9', 'password', NULL, 0),
(72, 'phfUzx', 'password', NULL, 0),
(73, 'seGsxJ', 'password', NULL, 0),
(74, 'tpXt9e', 'password', NULL, 0),
(75, 'H4rfcC', 'password', NULL, 0),
(76, 'xktGcN', 'password', NULL, 0),
(77, 'WoCwBk', 'password', NULL, 0),
(78, 'wOVz7x', 'password', NULL, 0),
(79, 'SJ92UU', 'password', NULL, 0),
(80, 'O9ZGPe', 'password', NULL, 0),
(81, 'C8q6KT', 'password', NULL, 0),
(82, 'j7P1I8', 'password', NULL, 0),
(83, 'Q7lthi', 'password', NULL, 0),
(84, 'r057H2', 'password', NULL, 0),
(85, 'IIlsaE', 'password', NULL, 0),
(86, '5zU2af', 'password', NULL, 0),
(87, 'TsiOA0', 'password', NULL, 0),
(88, 'G7Yh3v', 'password', NULL, 0),
(89, 'vnCPaT', 'password', NULL, 0),
(90, '7qpTK8', 'password', NULL, 0),
(91, 'e0ei4j', 'password', NULL, 0),
(92, 'NLUp9S', 'password', NULL, 0),
(93, 'dnwtXP', 'password', NULL, 0),
(94, 'DVBQG2', 'password', NULL, 0),
(95, '71paZs', 'password', NULL, 0),
(96, '1b9Jfo', 'password', NULL, 0),
(97, '6YiEOJ', 'password', NULL, 0),
(98, 'SjI7fd', 'password', NULL, 0),
(99, 'PK5HAG', 'password', NULL, 0),
(100, 'CCXxAi', 'password', NULL, 0);
...
--
ALTER TABLE `team_player`
  MODIFY `ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1501;
--
